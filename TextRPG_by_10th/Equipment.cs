...
public class Equipment      //장비 아이템 클래스
{
    ...
    //        //무기
    //        new Equipment(101, 1, "초심자의 목검 [평범]",0, 5, 0, "무기", "가벼워 다루기 좋은 검.", false, false, 1, 200),
    //        new Equipment(102, 1, "초심자의 단검 [평범]", 0, 5, 0, "무기", "가벼워 다루기 좋은 단검.", false, false, 1, 200),
    //        new Equipment(103, 1, "초심자의 활 [평범]", 0, 5, 0, "무기", "가벼워 다루기 좋은 활.", false, false, 1, 200),
    //        new Equipment(104, 1, "그레이트 클럽 [평범]", 0, 10, 0, "무기", "오우거의 소재로 만든 몽둥이. 외의로 강하다.", false, false, 1, 1000),
    //        new Equipment(105, 1, "더블핑거 대거 [평범]", 0, 10, 0, "무기", "오우거의 소재로 만든 단검. 가벼워 다루기 좋다.", false, false, 1, 1000),
    //        new Equipment(106, 1, "쉘 그레이트 보우 [평범]", 0, 10, 0, "무기", "오우거의 소재로 만든 활. 신축성이 강하다.", false, false, 1, 1000),
    ...
    //        //투구
    //        new Equipment(301, 1, "천 두건 [평범]", 0, 0, 5, "머리", "얇은 천으로 만든 두건.", false, false, 1,200),
    //        new Equipment(302, 1, "촉촉한 머리띠 [평범]", 0, 0, 10, "머리", "슬라임의 소재로 만든 투구. 물컹해서 기분 나쁘다.", false, false, 1,1000),
    ...
    //        //갑옷
    //        new Equipment(401, 1, "천 옷 [평범]", 0, 0, 5, "몸통", "천으로 만든 방어구.", false, false, 1,200),
    //        new Equipment(402, 1, "나무 갑옷 [평범]", 0, 0, 10, "몸통", "뿌리 정령의 소재로 만든 갑옷. 단단하지만 화염에 취약하다.", false, false, 1,1000),
    ...
    //        //장갑
    //        new Equipment(501, 1, "천 장갑 [평범]", 0, 0, 5, "손", "천으로 만든 장갑.", false, false, 1,200),
    //        new Equipment(502, 1, "그린 건틀릿 [평범]", 0, 0, 10, "손", "고블린의 소재로 만든 장갑. 의외로 튼튼하다.", false, false, 1,1000),
    ...
    //        //신발
    //        new Equipment(601, 1, "천 신발 [평범]", 0, 0, 5, "다리", "조잡한 신발.", false, false, 1,200),
    //        new Equipment(602, 1, "미끈거리는 신발 [평범]", 0, 0, 10, "다리", "거대 애벌레의 소재로 만든 신발. 오래 신으면 찝찝하다.", false, false, 1,1000),
...
public static class ConsoleExtensions
{
    public static string ColorText(this string text, ConsoleColor color)
    {
        return color switch
        {
            ConsoleColor.Blue => $"\u001b[94m{text}\u001b[0m",    // 밝은 파랑 - 희귀
            ConsoleColor.Magenta => $"\u001b[95m{text}\u001b[0m", // 밝은 보라 - 영웅
            ConsoleColor.Yellow => $"\u001b[93m{text}\u001b[0m",  // 밝은 노랑 - 전설
            ConsoleColor.Red => $"\u001b[91m{text}\u001b[0m",     // 밝은 빨강 - 유물

            ConsoleColor.Gray => $"\u001b[37m{text}\u001b[0m",    // 밝은 회색
            ConsoleColor.Green => $"\u001b[92m{text}\u001b[0m",   // 밝은 초록
