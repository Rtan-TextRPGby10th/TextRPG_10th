...
public class Equipment      //장비 아이템 클래스
{
    ...
    private static readonly Lazy<List<Equipment>> _equipmentCatalog = new Lazy<List<Equipment>>(() => new List<Equipment>
    {
            ...
            new Equipment(102, 0, "초심자의 단검 [평범]", 0, 5, 0, "무기", "가벼워 다루기 좋은 단검.", false, false, 1, 200),
            new Equipment(103, 0, "초심자의 활 [평범]", 0, 5, 0, "무기", "가벼워 다루기 좋은 활.", false, false, 1, 200),
            new Equipment(104, 1, "그레이트 클럽 [고급]".ColorText(ConsoleColor.Green), 0, 10, 0, "무기", "오우거의 소재로 만든 몽둥이. 외의로 강하다.", false, false, 1, 1000),
